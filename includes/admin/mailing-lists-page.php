    ...
    <div class=wrap>
        <form method="post">
			...
			if ( true === isset( $_GET['gm_error'] ) ) {
				/**
                 *
				 * The GNU-Mailman Integration WordPress plugin is vulnerable to Reflected Cross-Site Scripting via the
                 * gm_error parameter found in the ~/includes/admin/mailing-lists-page.php file which allows attackers
                 * to inject arbitrary web scripts, in versions up to and including 1.0.6.
                 *
                 * $$AK: Removing urldecode... not really needed
                 *
            ...
            <table class="form-table">
				...
				foreach ( $mailing_lists as $list ) {
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <input type="text" name="<?php echo $list['id']; ?>_name" class="regular-text code"
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <input type="text" name="<?php echo $list['id']; ?>_url" class="regular-text code"
                                   value="<?php echo $list['url']; ?>"/>
                        </td>
                    </tr>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <input type="text" name="<?php echo $list['id']; ?>_pass" class="regular-text code"
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <select name="<?php echo $list['id']; ?>_autosub">
                                <option value="0" <?php if ( $list['autosub'] == 0 ) {
									echo 'selected="selected"';
								} ?>>No
                                </option>
                                <option value="1" <?php if ( $list['autosub'] == 1 ) {
									echo 'selected="selected"';
								} ?>>Yes
                                </option>
                            </select>
                    ...
                    <tr>
                        <td colspan="2"><input type="button" name="<?php echo $list['id']; ?>_delete"
                                               class="button-primary"
                                               onClick="return confirm_delete('<?php echo $list['id']; ?>');"
                                               value="Delete <?php echo $list['name']; ?>"/></td>
                    </tr>
			...
			<?php if ( count( $mailing_lists ) > 0 ) { ?>
                <div class="submit"><input type="submit" name="info_update" class="button-primary"
                                           value="Update All Mailing Lists"/></div>
			<?php } ?>
        </form>
